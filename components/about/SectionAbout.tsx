        ...
        <div id="how-we-think" className="container-page">
          <div className="p-8 md:p-12">
            <div className="max-w-3xl">
              ...
              <p className="section-subtitle">{t('about.howWeThink.text1')}</p>
              <p className="section-subtitle">{t('about.howWeThink.text2')}</p>
              <p className="section-subtitle">{t('about.howWeThink.text3')}</p>
            </div>
          </div>
        </div>
